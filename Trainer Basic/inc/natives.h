...
namespace GRAPHICS
{
	...
	static void _SET_SCREEN_DRAW_POSITION(int p0, int p1) { invoke<Void>(0xB8A850F20A067EB6, p0, p1); } // 0xB8A850F20A067EB6 0x228A2598
	...
	static void DRAW_SCALEFORM_MOVIE_FULLSCREEN(Any scaleform, int p1, int p2, int p3, int p4) { invoke<Void>(0x0DF606929C105BE1, scaleform, p1, p2, p3, p4); } // 0x0DF606929C105BE1 0x7B48E696
...
namespace DECORATOR
{
	...
	static BOOL _DECOR_SET_FLOAT(Any p0, Any* p1, float p2) { return invoke<BOOL>(0x211AB1DD8D0F363A, p0, p1, p2); } // 0x211AB1DD8D0F363A
	...
	static float _DECOR_GET_FLOAT(Any p0, Any* p1) { return invoke<float>(0x6524A2F114706F43, p0, p1); } // 0x6524A2F114706F43
